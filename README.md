...
The vulnerability is not a coding bug in individual components, but a cross-component invariant failure:


the system assumes that positive pool reserves guarantee positive LP burn outputs, which does not hold in certain configurations.
